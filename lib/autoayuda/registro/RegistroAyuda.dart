...
class ListaNotasTexto {
  ...
  Future<void> cargarDatos() async {
    try {
      ...
      if (await file.exists()) {
        ...
        _notas = List<NotaTexto>.from(data['help_registries'].map((x) =>
            NotaTexto(
                id: x['id'],
                titulo: x['titulo'],
  ...
  void agregarNota(String uuid, String titulo, String texto, String compania,
      String qhpasado) {
    try {
      ...
      notaExistente.resumen = texto;
      notaExistente.compania = compania;
      notaExistente.qhpasado = qhpasado;
    } catch (e) {
...
class _EditorNotasState extends State<EditorNotas> {
  ...
  void initState() {
    ...
    _textController = TextEditingController(text: widget.nota?.resumen);
    ...
    if (widget.nota != null) {
      ...
      _textController.text = widget.nota!.resumen;
